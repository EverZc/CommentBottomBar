...
public class AudioPickActivityPicker extends PickerBaseActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case FilePicker.REQUEST_CODE_TAKE_AUDIO:
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_done) {
            ...
            intent.putParcelableArrayListExtra(FilePicker.RESULT_PICK_AUDIO, mSelectedList);
            ...
            try {
                ...
                startActivityForResult(intent, FilePicker.REQUEST_CODE_TAKE_AUDIO);
            } catch (Exception e) {
                e.printStackTrace();
                Toast.makeText(this, "手机未安装录音程序", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
